...
```sh
git clone https://github.com/rakeshmenon/react-webpack-setup.git
...
npm run dev
```
This will start the webpack dev server on the default port (8080). 
It will also start the express server from `server/index.js` using nodemon.
